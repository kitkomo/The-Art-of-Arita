...
if (window.innerWidth >= 768) {
	...
	links.forEach(link => link.addEventListener('mouseover', () => mouse.classList.add('link-visible')))
	links.forEach(link => link.addEventListener('mouseleave', () => mouse.classList.remove('link-visible')))
}